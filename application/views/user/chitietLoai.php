                                                    ...
                                                    <div class="row display-flex">
                                                        ...
                                                        <div class="col-md-2">
                                                            <table style="padding-top: 3px;" width="100%"
                                                                ...
                                                                <tr>
                                                                    <td width="120px" align="center" valign="top">
                                                                        <a id="dlstEdataFile_ctl50_lnkImage"
                                                                            title="Quy ước làng văn hóa : Huyện Thanh Oai. Tập 13A"
                                                                            href="wpDetail.aspx?Id=3913"><img
                                                                                id="dlstEdataFile_ctl50_imgImage"
                                                                                border="0" class="bookname"
                                                                                src="wpViewImage.ashx?Id=3913"
                                                                                style="height:120px;border-width:0px;" /></a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td valign="top" width="100%"
                                                                        style="vertical-align: top;" align="center">
                                                                        <a id="dlstEdataFile_ctl50_lnkTitle"
                                                                            class="bookname"
                                                                            href="wpDetail.aspx?Id=3913"
                                                                            style="color:Blue;font-weight:bold;">Quy ước
                                                                            làng văn hóa : Huyện Thanh Oai. Tập 13A</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
