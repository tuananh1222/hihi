                        ...
                        <form method="post" class="row" action="<?= base_url() ?>index.php/User/user/muonsach"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Mã sách</label>
                                    <input name="masach" type="text" list="ms" class="form-control">
                                    <datalist id="ms">
                                        <?php foreach ($dt as $value) : ?>
                                        <option value="<?= $value->masach ?>"><?= $value->tensach ?>
                                            <?php endforeach; ?>
                                    </datalist>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleI    nputPassword1">Ngay muon</label>
                                    <input name="ngaymuon" type="date" list="tl" class="form-control">

                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleI    nputPassword1">Ngay tra</label>
