                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview menu-open">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="<?= base_url() ?>index.php/admin/themmoi"><i
            ...
            <section class="content">
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <form method="post" class="row" action="<?= base_url() ?>index.php/admin/Themmoi"
                                enctype="multipart/form-data">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleI    nputPassword1">Tên</label>
                                        <input name="tensach" type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleI    nputPassword1">Nha cung cap</label>
                                        <input name="id_ncc" type="text" list="ncc" class="form-control">
                                        <datalist id="ncc">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="id_loai" type="text" list="tl" class="form-control">
                                        <datalist id="tl">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="id_nxb" type="text" class="form-control" list="nxb">
                                        <datalist id="nxb">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="sl_tong" type="number" class="form-control"
                                            id="exampleInputPassword1">
                                    </div>
                                    <div class="form-group">
