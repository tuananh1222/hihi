        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Bảng member</h3>
            </div>
            <form action="#" method="post" class="sidebar-form">
              <div class="input-group">
                <input type="text" name="searchlastname" class="form-control" placeholder="Nhập Lastname">
                        ...
                        <form method="post" action="<?= base_url() ?>index.php/Admin/admin/editmember">
                          <tbody>
                            <tr role="row" class="warning">
                              <td><input class="form-control" name="stt" type="hidden" value="<?= $value->stt ?>"></td>
                              <td><?= $value->stt ?></td>
                              <td><input class="form-control" name="firstname" type="text" value="<?= $value->firstname ?>"></td>
                              <td><input class="form-control" name="lastname" type="text" value="<?= $value->lastname ?>"></td>
                              <td><input class="form-control" name="email" type="text" value="<?= $value->email ?>"></td>
                              <td><input class="form-control" name="mobile" type="text" value="<?= $value->mobile ?>"></td>
                              <td><input class="form-control" name="password" type="text" value="<?= $value->password ?>"></td>
                              <td><input type="submit" name="add" value="ok" class="btn btn-primary" /> <a href="<?= base_url() ?>index.php/Admin/admin/editmember?stt=<?= $value->stt ?>"><i class="glyphicon glyphicon-remove"></i></a></td>
                            </tr>
                          </tbody>
                        </form>
                      <?php } else { ?>
