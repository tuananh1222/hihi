                    ...
                    <li class="active treeview menu-open">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?= base_url() ?>index.php/admin/themmoi"><i class="fa fa-circle-o"></i> Thêm
                                    mới</a></li>
                            <li class="active"><a href="<?= base_url() ?>index.php/admin/Cs_Sach"><i
                                        class="fa fa-circle-o"></i> Chỉnh sửa</a></li>
                        ...
                        <div class="box-header with-border">
                            ...
                            <form action="#" method="post" class="sidebar-form">
                                <div class="input-group">
                                    <input type="text" id="myInput" name="searchma" class="form-control"
                                            ...
                                            <form method="post" action="#">
                                                <tbody id="myTable">
                                                    <tr role="row" class="odd">
                                                        <td><input name="id_book" type="hidden"
                                                                value="<?= $value->id_book ?>"></td>
                                                        <td><?= $value->id_book ?></td>
                                                        <td><img src="<?= $value->img ?>" alt="" width="100px"
                                                                height="100px" class="img-circle"></td>
                                                        <td><input name="masach" type="text" width="50px"
                                                                value="<?= $value->masach ?>"></td>
                                                        <td><input name="tensach" type="text"
                                                                value="<?= $value->tensach ?>"></td>
                                                        <td><input name="id_ncc" list="ncc" type="text"
                                                                value="<?= $value->	id_ncc ?>">
                                                            <datalist id="ncc">
                                                        ...
                                                        <td><input name="id_nxb" type="text" list="nxb"
                                                                value="<?= $value->	id_nxb ?>">
                                                            <datalist id="nxb">
                                                        ...
                                                        <td><input name="loaisach" type="text" list="tl"
                                                                value="<?= $value->	id_loai ?>">
                                                            <datalist id="tl">
                                                        ...
                                                        <td><input name="tinhtrang" type="text"
                                                                value="<?= $value->	tinhtrang ?>"></td>
                                                        <td><input name="sl_tong" type="text"
                                                                value="<?= $value->sl_tong ?>"></td>
                                                        <td><input name="sl_conlai" type="text"
                                                                value="<?= $value->sl_conlai ?>"></td>
                                                        <td><input type="submit" name="update" value="ok"
                                                                class="btn btn-primary"> <a
                                                                href="<?= base_url() ?>index.php/admin/Cs_Sach?id_book=<?= $value->id_book ?>"><i
